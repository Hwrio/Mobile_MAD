...
public class RadioBtn_TableLayout extends TableLayout implements View.OnClickListener {
    private RadioButton mBtnCurrentRadio;

    public RadioBtn_TableLayout(Context context) {
        super(context);
    }

    public RadioBtn_TableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
